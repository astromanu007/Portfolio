          ...
          >
            ...
            <div className="pt-6 border-t border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-purple-600 via-indigo-600 to-cyan-500 flex items-center justify-center text-white font-bold font-mono text-base shadow-lg shadow-purple-500/30 shrink-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-[11px] font-mono text-gray-400 flex items-center gap-1 mt-0.5">
                    ...
                    <span className="leading-snug">{rec.institution}</span>
                  </div>
                </div>
              </div>
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-purple-600/20 hover:bg-purple-600/40 border border-purple-500/40 text-purple-300 font-mono text-xs font-semibold hover:text-white transition duration-300 w-full sm:w-auto shrink-0"
              >
